...
2. Group by Location (program:Line range). For each group:
   - Agents flagging = unique agents with finding at this location
   - Agents covering = agents whose domain scope includes this program
